...
public class    UsuarioControlador {
    ...
    public ResponseEntity<UsuarioEspecialDTO> guardar(@RequestBody Usuario datos){
        UsuarioEspecialDTO respuesta=this.servicio.guardarUsuarioEspecial(datos);
    ...
    public ResponseEntity<List<UsuarioGenericoDTO>>listar(){
        List<UsuarioGenericoDTO> respuesta=this.servicio.buscarTodosUsuarios();
    ...
    public ResponseEntity<UsuarioGenericoDTO>buscarPorId(@PathVariable Integer id){
        UsuarioGenericoDTO respuesta=this.servicio.buscarUsuarioId(id);
        return ResponseEntity.status(HttpStatus.OK).body(respuesta);
    }
